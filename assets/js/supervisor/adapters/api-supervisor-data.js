...
import { list, queryString as q, pageOf as nPage } from '../../core/adapter-helpers.js';
...
const nCommission = (c) => ({ id: c.id, bookingId: c.bookingId, amount: c.amount ?? null, currency: c.currency ?? null, status: c.status ?? 'pending_configuration', rate: c.rate ?? null, period: c.period ?? null, createdAt: c.createdAt ?? null, reversedAt: c.reversedAt ?? null });
