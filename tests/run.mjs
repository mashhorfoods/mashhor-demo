...
const SUITES = ['final', 'ghx', 'ghm', 'gfx', 'home', 'services', 'detail', 'destinations', 'offers', 'booking', 'supervisor', 'journey', 'account', 'integration', 'backend', 'supervisor-portal', 'ops-portal', 'rm', 'links'];
